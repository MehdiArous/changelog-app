    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center">
        ...
        <h1 className="text-2xl font-bold text-neutral-100 tracking-tight mb-2">
          Oops! Changelog not found
        </h1>
        <p className="text-sm text-neutral-400 max-w-sm mb-8 leading-relaxed">
          We couldn't find a changelog with ID <code className="text-xs bg-neutral-800 px-1.5 py-0.5 rounded text-neutral-300 font-mono">{id}</code>. It might have been deleted or moved.
        </p>
